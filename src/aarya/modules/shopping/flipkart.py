...
def generate_flipkart_headers(user_agent: str) -> dict:    
    ...
    #Find Browser/Brand for sec-ch-ua 
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            if status=="VERIFIED":
                ...
                "status_code": response.status_code, "exists": True, "rateLimit": False, "emailrecovery": None, "phoneNumber": None, "others": None}
            else:
                return {"name": name, "domain": domain, "method": method, "frequent_rate_limit": frequent_rate_limit,
                "exists": False, "rateLimit": False, "emailrecovery": None, "phoneNumber": None, "others": None}
        else:
            return {"name": name, "domain": domain, "method": method, "frequent_rate_limit": frequent_rate_limit,
                "exists": False, "rateLimit": True, "emailrecovery": None, "phoneNumber": None, "others": None}
    except Exception as e:
        return {"name": name, "domain": domain, "method": method, "frequent_rate_limit": frequent_rate_limit,
                "exists": False, "rateLimit": True, "emailrecovery": None, "phoneNumber": None, "others": str(e)}